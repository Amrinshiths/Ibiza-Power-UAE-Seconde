            ...
            <div class="lg:w-1/2 lg:mx-6">
                ...
                <div class="mt-6 space-y-8 md:mt-8">
                    <p class="flex items-start -mx-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mx-2 text-headingColor" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                        </svg>

                        <span class="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">
                        DUBAI U.A.E 15th st alqusais ind area 4 close to moontoys
                            P.O BOX 82656
                        </span>
                    </p>
                    ...
                    <p class="flex items-start -mx-2">
                        ...
                        <span class="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">+97142590647</span>
                    </p>
                    ...
                    <p class="flex items-start -mx-2">
                        ...
                        <span class="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">ibizapowerenergysystemllc@gmail.com</span>
                    </p>
                </div>
                ...
                <ul class="mt-4 flex justify-center lg:space-x-6 max-lg:flex-col max-lg:items-center max-lg:space-y-2 ">
                    <li class="flex items-center hover:text-blue-500">
                        ...
                        <a href="javascript:void(0)" class="text-current text-sm ml-3">
                            <strong>ibizapowerenergysystemllc@gmail.com</strong>
                        </a>
                    </li>
                    <li class="flex items-center text-current hover:text-blue-500">
                        ...
                        <a href="javascript:void(0)" class="text-current text-sm ml-3">
                            <strong> +971522707656</strong>
                        </a>
                        <a href="javascript:void(0)" class="text-current text-sm ml-3">
                            <strong> +971555757675</strong>
                        </a>
                    </li>
                </ul>
            </div>
